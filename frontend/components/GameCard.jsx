function GameCard({ game }) {
    return (
        <div className="cyber-card group relative overflow-hidden rounded-lg border border-white/10 hover:border-cyber-secondary/50 transition-all cursor-pointer bg-black/20">
            ...
            {/* Content */}
            <div className="p-4">
                <h3 className="font-bold text-white mb-1 group-hover:text-cyber-secondary transition-colors font-mono">
                    {game.title}
                </h3>
                <p className="text-xs text-cyber-muted mb-3 uppercase tracking-wider">
                    {game.genre}
                </p>

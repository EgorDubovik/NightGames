      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-sm font-mono px-1.5 py-0.5 rounded border border-white/20" title={player.location}>
              {player.flag}
            </span>
          </div>
            ...
            <div className="flex-1 h-1 bg-black/50 rounded-full overflow-hidden">
              <div
                className={`h-full rounded-full ${
                  player.ping < 50 ? "bg-cyber-success w-[90%]" : player.ping < 100 ? "bg-cyber-warning w-[60%]" : "bg-cyber-danger w-[30%]"
                }`}
              ></div>
            </div>

            ...
            <div className="glass-panel rounded-lg p-6 border-cyber">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                {players.map((player) => (
                  <div
                    key={player.id}
                    className="flex items-center gap-3 p-3 rounded-lg bg-black/20 border border-white/5 hover:border-cyber-primary/30 transition-all group cursor-pointer"
                  >
                    <div className="relative">
                      ...
                      />
                      <div
                        className={`absolute -bottom-0.5 -right-0.5 w-2.5 h-2.5 rounded-full border-2 border-cyber-black ${
